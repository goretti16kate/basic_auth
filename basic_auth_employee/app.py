...
FLAG = "FLAG{Basic_Auth_f9ea4fddbb99c0ee3175830ef8d5c011}"
...
class EmployeeEndpoint(Resource):
    @auth.login_required
    def get(self):
        ...
        if username == "employee":
            ...
            # return jsonify({
            #     "success": True,
            #     "message": f"Welcome {username}! Good Job! The 2/3 part of the flag is in my home page /employee"
            # })
        return jsonify({"message": "This enpoint requires credentials"}), 401
...
api.add_resource(EmployeeEndpoint, "/employee")
