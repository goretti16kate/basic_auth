...
FLAG = "FLAG{Userf9ea4f_employeeddbb99c0e_admine3175830ef8d5c011}"
...
class AdminEndpoint(Resource):
    ...
    def get(self):
        ...
        if username == "admin":
            ...
            # return jsonify({
            #     "sucess": True,
            #     "message": f"Welcome {username}! Congratulations!! The 3/3 part of the flag is in my home page /admin"
            # })
        return jsonify({"message": "Admin area restricted. Keep trying!"}), 401
...
api.add_resource(AdminEndpoint, "/admin")
